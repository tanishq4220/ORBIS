...
# ------------------------------------------------------------
# Operational prediction horizon used by the ML model.
#
# Reliability depends strongly on how far ahead we propagate.
# A short fixed 12 h window made almost every object look
# "RELIABLE". 24 h matches a typical conjunction screening
# window and lets orbital features separate satellites/debris.
#
